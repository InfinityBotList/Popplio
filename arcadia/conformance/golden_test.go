...
func TestGoldenPanelStrings(t *testing.T) {
	golden := []string{
		...
		// CDN.
		"Asset path already exists and is not a directory",
		"Asset path already exists",
		"Asset path is not a file",
		"Asset already exists",
		"Asset to be replaced is a directory",
		"Invalid CDN scope",
		"Chunk size is too large",
		"Chunk is empty",
		"Chunk does not exist",
		"Failed to generate a chunk ID",
		"No chunks were provided",
		"Too many chunks were provided",
		"SHA512 hash does not match",
		"copy_to location cannot be empty",
		"copy_to location already exists",
		"Fetching asset metadata failed: ",
		"Fetching asset metadata failed due to unknown error: ",
		"Could not find asset: ",
		"Reading file failed: ",
		"You do not have permission to upload chunks to the CDN right now [cdn.upload_chunk]",
		"You do not have permission to list the CDN's scopes right now [cdn.list_scopes]",
		...
		"User does not exist",
		"Fetching image metadata failed: ",
		...
		"You do not have permission to swap indexes of staff positions [staff_positions.swap_index]",
		"You do not have permission to set the indexes of staff positions [staff_positions.set_index]",
		...
		"You do not have permission to create staff disciplinary types [staff_disciplinary_types.create]",
		"You do not have permission to update staff disciplinary types [staff_disciplinary_types.update]",
		"You do not have permission to delete staff disciplinary types [staff_disciplinary_types.delete]",
		...
		"You do not have permission to create vote credit tiers [vote_credit_tiers.create]",
		"You do not have permission to update vote credit tiers [vote_credit_tiers.update]",
		"You do not have permission to delete vote credit tiers [vote_credit_tiers.delete]",
		...
		"You do not have permission to create shop item benefits [shop_item_benefits.create]",
		"You do not have permission to update shop item benefits [shop_item_benefits.update]",
		"You do not have permission to delete shop item benefits [shop_item_benefits.delete]",
		"You do not have permission to list shop coupons [shop_coupons.list]",
		"You do not have permission to create shop coupons [shop_coupons.create]",
		"You do not have permission to update shop coupons [shop_coupons.update]",
		"You do not have permission to delete shop coupons [shop_coupons.delete]",
		...
		"You do not have permission to view rpc logs [rpc_logs.view]",
		"Invalid method",
...
func TestGoldenRPCStrings(t *testing.T) {
	golden := []string{
		...
		"You need %s permission to use %s",
		...
		"Error decoding borealis response: %v",
