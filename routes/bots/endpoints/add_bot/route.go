...
type CreateBot struct {
	...
	Invite           string       `db:"invite" json:"invite" validate:"required,http" msg:"Invite is required and must be a valid HTTPS URL"`                                                                                                                // impld
	Banner           *string      `db:"banner" json:"banner" validate:"omitempty,http" msg:"Background must be a valid HTTPS URL"`                                                                                                                           // impld
