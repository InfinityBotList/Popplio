...
func Docs() *docs.Doc {
	return &docs.Doc{
		...
		Description: "Creates a new order returning the URL to complete the checkout in the payment provider chosen. Use this to buy a new perk for an entity from the shop",
