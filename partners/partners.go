...
var Partners = &types.PartnerList{}

func setupPartnerList() {
	Partners = &types.PartnerList{
		Featured: []*types.Partner{
			{
				...
				Image:  state.Config.Sites.CDN + "/images/png/discordbotconstructor-partner.png",
				Links: []types.Link{
					{
						Name:  "Discord",
		...
		BotPartners: []*types.Partner{
			{
				...
				Image:  state.Config.Sites.CDN + "/images/png/triviabot-partner.png",
				Links: []types.Link{
					{
						Name:  "View Trivia",
			...
			},
			{
				...
				Image:  state.Config.Sites.CDN + "/images/png/mysticwarriorbot-partner.png",
				Links: []types.Link{
					{
						Name:  "View Mystic",
			...
			},
			{
				...
				Image:  state.Config.Sites.CDN + "/images/png/antiraid-partner.png",
				Links: []types.Link{
					{
						Name:  "View Website",
			...
			},
			{
				...
				Image:  state.Config.Sites.CDN + "/images/png/melon-partner.png",
				Links: []types.Link{
					{
						Name:  "Website",
