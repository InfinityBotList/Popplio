...
type WebhookEvent interface {
	Event() WebhookType
	CreateHookParams(creator *dovewing.PlatformUser, targets Target) *discordgo.WebhookParams
}
...
type Target struct {
	Bot  *dovewing.PlatformUser `json:"bot,omitempty" description:"If a bot event, the bot that the webhook is about"`
...
type WebhookResponse[E WebhookEvent] struct {
	Creator   *dovewing.PlatformUser `json:"creator" description:"The user who created the action/event (e.g voted for the bot or made a review)"`
